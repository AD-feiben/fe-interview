- [指令](#--)
  * [v-show 与 v-if 区别](#v-show---v-if---)
  * [v-for 绑定的 key 的作用](#v-for-----key----)
  * [自定义指令](#-----)
- [生命周期](#----)
  * [生命周期执行顺序](#--------)
  * [父组件可以监听到子组件的生命周期吗？](#------------------)
- [双向绑定](#----)
  * [直接给一个数组项赋值，Vue 能检测到变化吗?](#-----------vue---------)
  * [双向绑定的原理](#-------)
- [路由](#--)
  * [vue-router 路由模式有几种？](#vue-router---------)
  * [能说下 vue-router 中常用的 hash 和 history 路由模式实现原理吗？](#----vue-router------hash---history-----------)
- [其他](#--)
  * [组件中 data 为什么是一个函数，而 new Vue 实例里，data 可以直接是一个对象？](#----data------------new-vue-----data-----------)
  * [样式加 scoped 与不加 scoped 的区别? 以及scoped 的实现原理](#----scoped-----scoped--------scoped------)
- [交流讨论](#----)
